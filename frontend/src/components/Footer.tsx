...
const Footer: React.FC<FooterProps> = ({ onMentionsLegalesClick, onPolitiqueConfidentialiteClick }) => {
    return (
        <footer className="bg-gray-50 border-t border-gray-300 py-4 px-4 sm:px-6 lg:px-8 mt-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-sm">
                        <div className="flex items-center gap-2 sm:gap-4">
                            <button
                                ...
                                className="text-gray-600 hover:text-gray-700 transition-colors duration-200 underline focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 rounded-sm"
                            >
                                Mentions légales
                            </button>
